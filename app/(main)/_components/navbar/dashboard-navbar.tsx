...
export const DashboardNavbar = () => {
  ...
  return (
    <div className={`relative p-1 border-b min-h-[50px] max-h-[60px] text-white w-full bg-primary shadow-sm flex items-center ${memoizedCompany?.role === "ADMIN" && "bg-red-500"}`}>
