...
export const ShowCertificate = ({certificate, baseUrl}:{certificate: Certificate, baseUrl:string}) => {
  return (
    <div>
          ...
          <DocumentCertificateTemplate
            ...
            expireDate={formatDateOf (addMonths(certificate.certificateDate || certificate.createdAt, certificate?.monthsToExpire!))}
          />
        </PDFViewer>
    </div>
  )
